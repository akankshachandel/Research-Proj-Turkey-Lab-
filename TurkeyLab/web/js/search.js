...
//            console.log(data);
                        ...
                        for (i = 0; i < birdArray.length; i++) {
                            ...
                            if (temp !== "undefined") {
                                ...
                                var p = "", q = "", r = "";
                                if (finalized !== "")
                            p = "<a href =\"C:\\Users\\amitabh\\Desktop\\Saved Files\\\"" + finalized + ">" + "Finalized File" + "</a><br>";

                        if (raw !== "")
                            q = "<a href =\"C:\\Users\\amitabh\\Desktop\\Saved Files\\\"" + raw + ">" + "Raw File" + "</a><br>";

                        if (gdf !== "")
                            r = "<a href =\"C:\\Users\\amitabh\\Desktop\\Saved Files\\\"" + gdf + ">" + "GDF File" + "</a>";
